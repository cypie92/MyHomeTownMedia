      ...
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        >
          ...
          <a
            ...
            className="group inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-8 py-3.5 font-heading text-base font-bold text-white shadow-lg shadow-[#25D366]/25 transition-all hover:bg-[#128C7E] hover:shadow-xl hover:shadow-[#25D366]/30"
          >
